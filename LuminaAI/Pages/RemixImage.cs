...
namespace Live_Earth_Map.Pages
{
    class RemixImage
    {
        ...
        //Constructor
        public RemixImage(AppiumDriver<IWebElement> driver, ExtentTest test)
        {
            this.driver = driver;
            this.Test = test;
        }
        ...
        IWebElement RemixImageMenu => driver.FindElementById("");
        ...
        IWebElement BackToEditScreen => driver.FindElementById("");
        ...
        IWebElement GenerateMore1 => driver.FindElementById("com.lumina.aiart.artgenerator.artavatar:id/generateMore");
        IWebElement GMX => driver.FindElementById("//android.widget.LinearLayout[@resource-id=\"com.lumina.aiart.artgenerator.artavatar:id/generateMore\"]");
